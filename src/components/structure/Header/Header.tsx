...
return (
    <nav className="w-full md:p-8 flex items-center justify-center">
        <div className="max-w-screen-2xl w-full flex flex-wrap justify-between items-center justify-between p-4 md:rounded-2xl md:shadow-lg md:shadow-rose-600 md:dark:shadow-none md:dark:inset-shadow-sm md:dark:inset-shadow-sky-400">
