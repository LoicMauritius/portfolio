...
export const NavBar = () => {
  ...
  return (
    <>
      ...
      <div className={`absolute top-12 right-0 w-2/5 z-50 md:static items-center justify-between ${mobileMenuOpen ? "block" : "hidden"} md:w-full md:flex md:w-auto md:order-1 md:mr-4`} id="navbar-language">
